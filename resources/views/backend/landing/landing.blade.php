    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="mb-3 mb-lg-1"></div><!-- End .mb-3 mb-lg-5 -->
                ...
                <div class="category-banners-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl"
                    ...
                    {{-- <div class="banner banner-poster">
                        ...
                        <div class="banner-content">
                            <h2 class="banner-title">Booking lapangan badminton?</h2><!-- End .banner-subtitle -->
                            <h2 class="banner-title">Hanya di badmintonnyaPadang</h2><!-- End .banner-title -->
                        </div><!-- End .banner-content -->
                    </div><!-- End .banner -->
                    <div class="banner banner-poster">
                        ...
                        <div class="banner-content banner-content-right">
                            <h2 class="banner-title">Punya bisnis lapangan badminton?</h2>
                            <h2 class="banner-title">Segera daftarkan disini !</h2>
                            <!-- End .banner-title -->
