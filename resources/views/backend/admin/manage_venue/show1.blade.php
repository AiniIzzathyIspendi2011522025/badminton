                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tickets">
                                    <div class="ticket-items" id="ticket-items">
                                        <div class="gallery gallery-fw" data-item-height="400">
                                            <strong><center>Surat IMB</center> </strong>
                                            @if ($venues->imb == NULL)
                                ...
                                <div class="ticket-content">
                                    <div class="ticket-header">
                                        ...
                                        <div class="ticket-detail">
                                            <div class="ticket-title">
                                                <h4>{{$venues->owner->first_name}} {{$venues->owner->last_name}}</h4>
                                            </div>
                                    ...
                                    <div class="ticket-description">
                                        ...
                                        <h6><b>Foto KTP</b></h6>
                                        <p><figure >
                                            <img style="width:300px;;height:200px;" src="{{ asset('templates/img/avatar/avatar-5.png') }}" alt="">
                                        </figure></p>
                                    ...
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="badges">
                                                ...
                                                @if ($open->status == 2)
                                                <span class="badge badge-success">{{$open->Hour->hour}}</span>
                                                @else
