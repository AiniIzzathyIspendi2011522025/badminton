            ...
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <figure>
                                        <img src="{{ asset('images/imb/'.$venues->imb) }}" alt="Trulli" style="width:100%">
                                    </figure>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" class="btn btn-success btn-icon icon-left btn-lg btn-block mb-4 d-md-none"
                                    ...
                                    <div class="ticket-description">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p><b>- Pembayaran dengan DP sebesar {{$venues->dp_percentage}} %</b>
                                                    <br>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                @foreach($venues->ActiveFacilityDetail() as $facility)
                                                    ...
                                                    <span class="d-inline-block" data-toggle="tooltip"
                                                        data-title="{{$facility->Facility->name}}" data-placement="right">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p>
                                                    ...
                                                    <b>- {{$payment->PaymentMethod->name}} ( {{$payment->no_rek}} )</b>
                                                    <br>
                                                    @endforeach
                                                </p>
                                            </div>
                                    ...
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="badges">
                                                ...
                                                @if ($open->status == 2)
                                                <span class="badge badge-info">{{$open->Hour->hour}}</span>
                                                @else
...
{!! Form::open(['method'=>'DELETE','route'=>['owner.venue.destroy',0],
'style'=>'display.none','id'=>'deleted_venue'])!!}
{!! Form::close() !!}
