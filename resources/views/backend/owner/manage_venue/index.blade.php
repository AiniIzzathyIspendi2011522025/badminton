                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a style="float:right; margin-right:5px;" href="#">
                            <button onclick="warning()" class="btn btn-success" type="button">Tambah Lapangan</button>
                        </a>
                        @endif

                    </div>
                    <div class="card-body">
                        <h3><center>Data Lapangan Kosong !</center> </h3>
                        <p><center>Lapangan terkonfirmasi</center></p>
                    </div>
                    <!-- /.card -->
                </div>
                <!-- /.col -->
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-footer">
                                    <div class="text-right">
                                        <a class="btn btn-sm btn-success" @if ($venue->status ==
                                            1)
