                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @if ($rents->status == 2)
                            ...
                            <a type="button" style="float:right;margin-left:200px;" class="btn btn-success"
                                onclick="extend(`+data+`)" data-toggle="modal" data-target="#modal-extend">
                                Perpanjang Booking
                            </a>
                        @elseif ($rents->status == 1)
                            <span style="float:right;margin-left:5px;" class="badge badge-success" >Booking Sedang Diajukan</span>
