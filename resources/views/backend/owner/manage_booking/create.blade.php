<div class="modal fade" id="modal-booking">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {{ Form::open(array('method'=>'POST', 'url' => route('owner.booking.store'))) }}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tenant_name" placeholder="Inputkan nama penyewa">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Tanggal </label>
                            <input type="date" class="form-control" name="date" id="c_date" onchange="dateChange()">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            myselect2','required'=>'required','id'=>'c_venue']) !!}
                            @error('venue')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            myselect2','required'=>'required','id'=>'c_field']) !!}
                            @error('field')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
